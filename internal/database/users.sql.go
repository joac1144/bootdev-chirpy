...
func (q *Queries) UpdateChirpyRedStatus(ctx context.Context, arg UpdateChirpyRedStatusParams) error {
	_, err := q.db.ExecContext(ctx, updateChirpyRedStatus, arg.IsChirpyRed, arg.ID)
	return err
}
